...
while true
    ...
    data(1).TimeStamp(end+1) = vbl;
    data(1).Txi(end+1) = screen_targetX;
    data(1).Tyi(end+1) = screen_targetY;
    data(1).Tzi = 0;
    data(1).onTarget(end+1) = checkTarget(screen_targetX,screen_targetY,xCenter,yCenter,crsHr_height,crsHr_height);
    ...
    if frameCounter >= framesPerUpdate 
        ...
        screen_b_DotsX = bgDotsX - cameraX;
        screen_b_DotsY = bgDotsY - cameraY;
        ...
        Screen('DrawDots', win, visibleDots, b_dotSize, b_dotColor, [], 2); % Draw background dots
